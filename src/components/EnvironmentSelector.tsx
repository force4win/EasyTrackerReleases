...
export default function EnvironmentSelector({
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-72 fa-glass-window rounded-2xl overflow-hidden shadow-2xl z-50 animate-in fade-in slide-in-from-top-2 duration-200">
          {/* Lista de ambientes */}
